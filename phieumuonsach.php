            ...
            <div class="card-body">
              ...
              <table class="table datatable align-middle">
                ...
                <tbody>
                  <?php
                  global $conn;
                  $sql = "SELECT p.id_phieu AS Ma_phieu, p.id_rd_card AS Ma_the_muon, b.ten_sach AS Sach, p.ngay_muon AS Ngay_muon, p.ngay_het_han AS Ngay_het_han, p.ngay_tra AS Ngay_tra, p.tinh_trang_tra AS Tinh_trang FROM phieu p LEFT JOIN book_print bp ON p.id_print = bp.id_print LEFT JOIN book b ON bp.id_book = b.id_sach;";
