...
<head>
  ...
  <title>Quản lý lĩnh vực - <?php echo WEB_NAME ?></title>
      ...
      <div class="modal-content">
        <form action="" method="post">
          ...
          <div class="modal-body">
            <div class="mb-3">
              <label for="tentacgia">Lĩnh vực</label>
        ...
        if (isset($_POST['tao'])) {
          $ten = $_POST['ten'];
          $sql = "INSERT INTO field (ten) VALUES ('$ten')";
          if (transitionSQL($sql)) {
            echo "<script>alert('Thêm lĩnh vực thành công')</script>";
          } else {
            echo "<script>alert('Thêm lĩnh vực thất bại.')</script>";
          }
        }
        ?>
      </div>
